...
import { UploadCloud, CheckCircle, AlertTriangle, Search, ShieldCheck, Cpu, Target, Zap, Crosshair, LayoutGrid, Activity } from 'lucide-react';
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-0.5">
                          ...
                          {result.engine && (
                            <span className="text-[9px] px-1.5 py-0.5 rounded bg-white/5 border border-white/10 text-white/30 font-mono italic">
                              {result.engine}
                            </span>
                          )}
                        </div>
                    ...
                    {result.certainty && (
                      <div className="flex flex-col items-end">
                        <span className={`text-[10px] font-bold uppercase tracking-tighter px-2 py-0.5 rounded-full border ${
                          result.certainty === 'High' ? 'bg-green-500/10 border-green-500/20 text-green-400' :
                          result.certainty === 'Medium' ? 'bg-amber-500/10 border-amber-500/20 text-amber-400' :
